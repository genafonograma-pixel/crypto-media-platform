...
export default function AboutPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#050505] text-[#F5F5F5] font-sans">
      <SEO title="About Us & Market Coverage | Wild West Crypto Show" description="About Wild West Crypto Show — AI-powered cryptocurrency news and market intelligence platform." />
      <Header />
      <main className="flex-1 max-w-[800px] w-full mx-auto px-4 py-12">
        ...
        <h1 className="text-4xl font-black mb-6 text-white">About Wild West Crypto Show</h1>
        <div className="prose prose-invert prose-p:text-[#CCC] prose-p:leading-relaxed max-w-none">
          <p>Wild West Crypto Show is an AI-powered cryptocurrency news and market intelligence platform. We aggregate, analyze, and synthesize information from across the crypto ecosystem to give readers a clear, unbiased view of what is happening in digital asset markets.</p>
          ...
          <h3>How We Work</h3>
          <p>See our <Link to="/methodology" className="text-[#F4A917] hover:underline">AI Methodology page</Link> for a detailed explanation of how Wild West Crypto Show ingests, processes, and presents information.</p>
        </div>
      </main>
      <Footer />
    </div>
