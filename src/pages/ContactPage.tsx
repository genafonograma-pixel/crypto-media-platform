    ...
    <div className="min-h-screen flex flex-col bg-[#050505] text-[#F5F5F5] font-sans">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-4 py-12">
        ...
        <div className="prose prose-invert prose-p:text-[#CCC] prose-p:leading-relaxed max-w-none">
          ...
          <p>Email: <a href="mailto:hello@crypton.news" className="text-[#F4A917] hover:underline">hello@crypton.news</a></p>
          <h3>Advertising</h3>
          <p>For advertising and partnership opportunities, email: <a href="mailto:advertise@crypton.news" className="text-[#F4A917] hover:underline">advertise@crypton.news</a></p>
          <h3>Editorial</h3>
          <p>For corrections or news tips: <a href="mailto:news@crypton.news" className="text-[#F4A917] hover:underline">news@crypton.news</a></p>
        </div>
      </main>
      <Footer />
    </div>
